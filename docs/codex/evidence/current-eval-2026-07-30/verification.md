...
> Historical campaign-time snapshot. It predates two later lit tests and is
> retained unchanged for provenance. The current repository-wide review gate is
> recorded in
> [`current_document_review_verification.md`](current_document_review_verification.md);
> use that file for current pass counts.
