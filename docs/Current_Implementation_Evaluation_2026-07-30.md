...
`runtime-full` 的 telemetry 证明新技术不是“只配置未执行”：
...
- `docs/evidence/lava_m_current_2026_07_30/base64_summary.json`
- `docs/evidence/lava_m_current_2026_07_30/base64_summary.csv`
- `docs/evidence/lava_m_current_2026_07_30/base64_manifest.json`
- `docs/evidence/lava_m_current_2026_07_30/md5sum_summary.json`
- `docs/evidence/lava_m_current_2026_07_30/uniq_summary.json`
- `docs/evidence/lava_m_current_2026_07_30/who_summary.json`
...
| 全量 lit | **209/209 passed**，本次复跑 133.83 s |
